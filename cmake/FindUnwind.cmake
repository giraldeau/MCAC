...
elseif(
    ...
    OR CMAKE_SYSTEM_PROCESSOR STREQUAL "corei7-64"
)
...
if(Unwind_LIBRARY)
    ...
    if(EXISTS ${_Unwind_VERSION_HEADER})
        ...
        set(Unwind_VERSION ${Unwind_VERSION_MAJOR}.${Unwind_VERSION_MINOR}.${Unwind_VERSION_PATCH})
        set(Unwind_VERSION_COMPONENTS 3)
    endif(EXISTS ${_Unwind_VERSION_HEADER})
endif(Unwind_LIBRARY)

# handle the QUIETLY and REQUIRED arguments and set Unwind_FOUND to TRUE if all listed variables are
# TRUE
...
if(Unwind_FOUND)
    if(NOT TARGET unwind::unwind)
        ...
        set_property(
            TARGET unwind::unwind PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${Unwind_INCLUDE_DIR}
        )
        set_property(
            TARGET unwind::unwind PROPERTY INTERFACE_LINK_LIBRARIES ${Unwind_LIBRARY}
                                           ${Unwind_PLATFORM_LIBRARY}
        )
