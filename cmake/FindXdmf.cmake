...
find_path(Xdmf_INCLUDE_DIR NAMES XdmfDomain.hpp
        HINTS
        ${PC_Xdmf_INCLUDEDIR}
...
find_package_handle_standard_args(Xdmf
                                  REQUIRED_VARS Xdmf_LIBRARY XdmfCore_LIBRARY Xdmf_INCLUDE_DIR)

if(Xdmf_FOUND AND NOT TARGET Xdmf::Xdmf)
    add_library(Xdmf::Xdmf UNKNOWN IMPORTED)
    set_target_properties(Xdmf::Xdmf PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${Xdmf_INCLUDE_DIRS}")
...
if(Xdmf_FOUND AND NOT TARGET Xdmf::XdmfCore)
    ...
    set_target_properties(Xdmf::XdmfCore PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${Xdmf_INCLUDE_DIRS}")
