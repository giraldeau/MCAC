...
double distance(std::array<double, 3> point_1,
                std::array<double, 3> point_2,
                double box_size) noexcept;
double relative_distance(std::array<double, 3> point_1, std::array<double, 3> point_2) noexcept;
double distance_2(std::array<double, 3> point_1, std::array<double, 3> point_2,
                  double box_size) noexcept;
double relative_distance_2(std::array<double, 3> point_1, std::array<double, 3> point_2) noexcept;
