...
boost::shared_ptr<XdmfGeometry> the_positions(const std::vector<double> &formatted_positions);
template<class T>
boost::shared_ptr<XdmfAttribute> scalar(const std::string &name, const std::vector<T> &formatted_field);
template<class T>
