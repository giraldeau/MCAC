...
Or give me the aggregates array so I can compute it for you""")
    ...
    typed_data = np.zeros_like(data, dtype=np.int)
...
if __name__ == "__main__":
    ...
    export_ddscat(Spheres, last_agg, aggregates=Aggregates, type_limits=[-0.2, 0.])
